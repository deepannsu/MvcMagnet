...
namespace MvcMagnet.Controllers
{
    public class MagnetsController : Controller
    {
        private readonly MvcMagnetContext _context;

        public MagnetsController(MvcMagnetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Life,type,color,Price")] Magnet magnet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Life,type,color,Price")] Magnet magnet)
        {
            if (id != magnet.Id)
            {
                return NotFound();
